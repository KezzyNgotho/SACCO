  ...
  <Text>Talk to us</Text>
    ...
    <Image
      ...
      <Image
             ...
             // style={styles.saveimg}
            ></Image>
      <Text   style={{fontSize:15,fontWeight:'bold',alignSelf:'center',color:'black',marginLeft:30}}>SALES</Text>
      </TouchableOpacity>
      <TouchableOpacity
      ...
      <Image
             ...
             // style={styles.saveimg}
            ></Image>
      <Text style={{fontSize:15,fontWeight:'bold',color:'black',marginLeft:60}}> STORE</Text>
      </TouchableOpacity>
...
style={{
  ...
  <Image
   ...
   <View>
   <Text style={{color:'black',fontSize:20,fontWeight:'bold',fontStyle:'italic',marginTop:20,marginHorizontal:30}}>Thank you for choosing us!! :():</Text>
   </View>
   </ScrollView>
